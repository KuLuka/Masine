...
import { both } from './PneuSejaliceList';
...
const PneuSejaliceProduct = ({ match }) => {
                    ...
                    <div className='product-page-content'>
                        ...
                        <motion.div
                            ...
                            <div className="product-page-li">
                                ...
                                <Link className='nazad' to='/ratarstvo/pneumatske-sejalice'>Nazad</Link>
                            </div>
                        </motion.div>
                    </div>
...
export default PneuSejaliceProduct;