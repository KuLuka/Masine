...
import { both } from './MixPrikoliceList';
...
const MixPrikoliceProduct = ({ match }) => {
                    ...
                    <div className='product-page-content'>
                        ...
                        <motion.div
                            ...
                            <div className="product-page-li">
                                ...
                                <Link className='nazad' to='/transport/mix-prikolice'>Nazad</Link>
                            </div>
                        </motion.div>
                    </div>
...
export default MixPrikoliceProduct;