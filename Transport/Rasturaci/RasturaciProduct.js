...
import { both } from './RasturaciList';
                    ...
                    <div className='product-page-content'>
                        ...
                        <motion.div
                            ...
                            <div className="product-page-li">
                                ...
                                <Link className='nazad' to='/transport/rasturaci-stajnjaka'>Nazad</Link>
                            </div>
                        </motion.div>
                    </div>
...
export default RasturaciProduct;