...
import { both } from './RasturaciSenaList';
...
const RasturaciSenaProduct = ({ match }) => {
                    ...
                    <div className='product-page-content'>
                        ...
                        <motion.div
                            ...
                            <div className="product-page-li">
                                ...
                                <Link className='nazad' to='/stocarstvo/rasturaci-sena'>Nazad</Link>
                            </div>
                        </motion.div>
                    </div>


                    <div className="teh-spec">
                        <SmallTable
                            teh_kar={all.teh_kar}
...
export default RasturaciSenaProduct;