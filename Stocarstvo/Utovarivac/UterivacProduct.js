                    ...
                    <div className='product-page-content'>
                        ...
                        <motion.div
                            ...
                            <div className="product-page-li">
                                ...
                                <Link className='nazad' to='/stocarstvo/hirdaulicni-utovarivac-stajnjaka'>Nazad</Link>
                            </div>
                        </motion.div>
                    </div>
...
export default UterivacProduct;